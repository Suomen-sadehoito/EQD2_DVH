...
Tämä on Varian Eclipse -hoitosuunnittelujärjestelmään (TPS) tarkoitettu ESAPI-skripti, joka laskee ja visualisoi 2 Gy:n ekvivalenttiannoksen (EQD2) annostilavuushistogrammeja (DVH).
